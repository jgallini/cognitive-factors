...
library(ggmagnify)
library(scales)
here::i_am("Code/tables_figures_gh.R")
library(here)

#bringing in data
load(here("Data","test_gh.Rda"))
load(here("Data","train_gh.Rda"))
load(here("Data","powerlist_gh.Rda"))
load(here("Data","nlist_gh.Rda"))
load(here("Data","eventlist_gh.Rda"))
load(here("Data","hrlist_gh.Rda"))
